...
<head>
   ...
   <?=Html::cssFile('@web/css/vender.min.css')?>
...
<body>
      ...
      <div id="call-to-action">	       
		   ...
		   <div class="row section-ads">
		      ...
		      <div class="twelve columns">		         		
			      ...
			      <h2><a href="http://sc.chinaz.com">Styleshout Recommends Dreamhost<span>.</span></a></h2>
			      ...
			      Looking for an awesome and reliable webhosting? Try DreamHost.
					...
					<div class="action">
			         <a href="http://sc.chinaz.com" >Sign Up Now</a>
	         	</div>
   ...
   <footer>
      ...
      <div class="row">  
         ...
         <ul class="copyright">
         	<li>Copyright &copy; 2015.Company name All rights reserved.</li> 
   ...
   <?=Html::jsFile('@web/js/jquery.flexslider-min.js')?>
   <?=Html::jsFile('@web/js/jquery.waypoints.min.js')?>
   <?=Html::jsFile('@web/js/jquery.validate.min.js')?>
   <?=Html::jsFile('@web/js/jquery.fittext.js')?>
   <?=Html::jsFile('@web/js/jquery.placeholder.min.js')?>
   <?=Html::jsFile('@web/js/jquery.magnific-popup.min.js')?>
