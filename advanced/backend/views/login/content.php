...
<head>
    ...
    <?=Html::cssFile('@web/adminassets/css/index.css')?>
	<title>后台管理系统</title>
</head>
<body>
	...
	<div class="leftmenu">
		<div class="leftmenu_0">
			...
			<dl>
				...
				<dd >
					<ul class="clearfix">
						<li ><a href="javascript:;" _link="introduce.html"  style = "margin-left: 20px">公司介绍</a></li>
    ...
    <?=Html::jsFile('@web/adminassets/public/js/jquery-3.1.1.js')?>
    <?=Html::jsFile('@web/adminassets/bootstrap/js/bootstrap.min.js')?>
    <?=Html::jsFile('@web/adminassets/public/js/banner.js')?>
